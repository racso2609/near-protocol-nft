/*
 * Example smart NftConTract written in RUST
 *
 * Learn more about writing NEAR smart NftConTracts with Rust:
 * https://near-docs.io/develop/NftConTract
 *
 */
...
// Define the NftConTract structure
#[near_bindgen]
...
// Implement the NftConTract structure
#[near_bindgen]
impl NftContract {
    #[init]
    pub fn new_default_meta(owner_id: AccountId) -> Self {
        Self::new(
            ...
            NFTContractMetadata {
                ...
                name: "Racso Example 1".to_string(),
                symbol: "Racso".to_string(),
